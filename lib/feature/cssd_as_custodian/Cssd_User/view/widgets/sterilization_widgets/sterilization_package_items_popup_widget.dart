...
class SterilizationPackageItemsPopupWidget extends StatelessWidget {
  const SterilizationPackageItemsPopupWidget({
    super.key,
  });
        ...
        return Card(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text(request.requestTitle,style: FontStyles.bodyPieTitleStyle,),
